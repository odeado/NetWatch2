@echo off
REM Win NetWatch RMM - Escaneo continuo de Iquique, sin depender de VPN.
...
"%PYEXE%" -u scanner.py --subnet 172.30.112.0/24 --repeat 120 --firebase-sitio iquique --workers 150 >> scan_iquique.log 2>&1
